...
public class ExpandAdapter extends BaseExpandableListAdapter {
    ...
    private ArrayList<CategoryList> mParent;
    private ExpandableListView accordion;
    public int lastExpandedGroupPosition;


    public ExpandAdapter(Context context, ArrayList<CategoryList> parent, ExpandableListView accordion) {
        mParent = parent;
    ...
    @Override
    //counts the number of childNameList items so the list knows how many times calls getChildView() method
    public int getChildrenCount(int i) {
        return mParent.get(i).childNameList.size();
    }

    @Override
    //gets the title of each parent/group
    public Object getGroup(int i) {
        return mParent.get(i).groupName;
    }

    @Override
    //gets the groupName of each item
    public Object getChild(int i, int i1) {
        return mParent.get(i).childNameList.get(i1);
    }
    ...
    public View getGroupView(int i, boolean b, View view, ViewGroup viewGroup) {
        ...
        // set category groupName as tag so view can be found view later
    ...
    @Override
    //in this method you must set the text to see the childNameList on the list
    public View getChildView(int i, int i1, boolean b, View view, ViewGroup viewGroup) {
        ...
        textView.setText(mParent.get(i).childNameList.get(i1));
